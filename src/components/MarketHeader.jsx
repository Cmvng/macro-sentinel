    ...
    <div style={{ paddingTop: '1rem', paddingBottom: '0.75rem' }}>
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '1rem', flexWrap: 'wrap', gap: 8 }}>
        <div>
          ...
          {dominantTheme && (
            <div style={{ marginTop: 6, fontSize: 11, color: 'var(--amber)', fontFamily: 'var(--font-mono)', display: 'flex', alignItems: 'center', gap: 5, flexWrap: 'wrap' }}>
        ...
        <div style={{ display: 'flex', gap: 6, alignItems: 'center', flexWrap: 'wrap' }}>
          <div style={{
            ...
            borderRadius: 'var(--radius-md)', fontSize: 10, color: 'var(--text-secondary)',
        ...
        {[
          ...
          return (
            <div key={s.label} style={{
              ...
              <div style={{ fontSize: 8, color: 'var(--text-muted)', fontFamily: 'var(--font-mono)', letterSpacing: '0.8px', marginBottom: 3 }}>
                {s.label}
              </div>
              <div style={{ fontSize: 18, fontWeight: 600, color: s.col, fontFamily: 'var(--font-display)' }}>
                {s.val}
              </div>
            </div>
          )
      ...
      {marketSummary && (
        <div style={{
          ...
          marginBottom: '0.75rem', borderLeft: '2px solid var(--accent-cyan)'
        }}>
          {marketSummary}
        </div>
      )}
      ...
      <div style={{
        display: 'flex', gap: 3, background: 'var(--bg-surface)',
